...
public class Emporium {
    ...
    public void addOrder(Order order) {
        orders.add(order);
        // favoriteServings.get(order.getCustomer());
        // for(var i :order.servings()) favoriteServings.put(order.getCustomer(),i);
    }
    ...
    private MultiMap<Customer,Serving> favoriteServings;
}
